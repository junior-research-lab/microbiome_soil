...
```{r import tables}
df_phylum <- read_excel("16S_phylum_reads.xlsx")
df_order <- read_excel("16S_order_reads.xlsx")
df_family <- read_excel("16S_family_reads.xlsx")
df_gender <- read_excel("16S_gender_reads.xlsx")
...
chao_phylum_16S <- ddply(df_phylum,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})


# ACE for Phylum of 16S
ACE_phylum_16S <- ddply(df_phylum,~Samples,function(x) {
...
corr_phy_16S_shann_B <- cor.test(x=data_phylum_16S_B$`ECe _values`, y=data_phylum_16S_B$SHANNON, method = "spearman")
...
phy.ranked.shann_B <- data.frame(cbind(rank(data_phylum_16S_B$`ECe _values`, ties.method = "average"), rank(data_phylum_16S_B$SHANNON, ties.method = "average")))
...
corr_phy_16S_sim_B <- cor.test(x=data_phylum_16S_B$`ECe _values`, y=data_phylum_16S_B$SIMPSON, method = "spearman")
...
phy.ranked.sim_B <- data.frame(cbind(rank(data_phylum_16S_B$`ECe _values`, ties.method = "average"), rank(data_phylum_16S_B$SIMPSON, ties.method = "average")))
...
corr_phy_16S_shann_R <- cor.test(x=data_phylum_16S_R$`ECe _values`, y=data_phylum_16S_R$SHANNON, method = "spearman")
...
phy.ranked.shann_R <- data.frame(cbind(rank(data_phylum_16S_R$`ECe _values`, ties.method = "average"), rank(data_phylum_16S_R$SHANNON, ties.method = "average")))
...
corr_phy_16S_sim_R <- cor.test(x=data_phylum_16S_R$`ECe _values`, y=data_phylum_16S_R$SIMPSON, method = "spearman")
...
phy.ranked.sim_R <- data.frame(cbind(rank(data_phylum_16S_R$`ECe _values`, ties.method = "average"), rank(data_phylum_16S_R$SIMPSON, ties.method = "average")))
...
chao_order_16S <- ddply(df_order,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})


# ACE for Phylum of 16S
ACE_order_16S <- ddply(df_order,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
corr_ord_16S_shann_B <- cor.test(x=data_order_16S_B$`ECe _values`, y=data_order_16S_B$SHANNON, method = "spearman")
...
ord.ranked.shann_B <- data.frame(cbind(rank(data_order_16S_B$`ECe _values`, ties.method = "average"), rank(data_order_16S_B$SHANNON, ties.method = "average")))
...
corr_ord_16S_sim_B <- cor.test(x=data_order_16S_B$`ECe _values`, y=data_order_16S_B$SIMPSON, method = "spearman")
...
ord.ranked.sim_B <- data.frame(cbind(rank(data_order_16S_B$`ECe _values`, ties.method = "average"), rank(data_order_16S_B$SIMPSON, ties.method = "average")))
...
corr_ord_16S_shann_R <- cor.test(x=data_order_16S_R$`ECe _values`, y=data_order_16S_R$SHANNON, method = "spearman")
...
ord.ranked.shann_R <- data.frame(cbind(rank(data_order_16S_R$`ECe _values`, ties.method = "average"), rank(data_order_16S_R$SHANNON, ties.method = "average")))
...
corr_ord_16S_sim_R <- cor.test(x=data_order_16S_R$`ECe _values`, y=data_order_16S_R$SIMPSON, method = "spearman")
...
ord.ranked.sim_R <- data.frame(cbind(rank(data_order_16S_R$`ECe _values`, ties.method = "average"), rank(data_order_16S_R$SIMPSON, ties.method = "average")))
...
chao_family_16S <- ddply(df_family,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})

# ACE for Phylum of ITS2
ACE_family_16S <- ddply(df_family,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
corr_fam_16S_shann_B <- cor.test(x=data_family_16S_B$`ECe _values`, y=data_family_16S_B$SHANNON, method = "spearman")
...
fam.ranked.shann_B <- data.frame(cbind(rank(data_family_16S_B$`ECe _values`, ties.method = "average"), rank(data_family_16S_B$SHANNON, ties.method = "average")))
...
corr_fam_16S_sim_B <- cor.test(x=data_family_16S_B$`ECe _values`, y=data_family_16S_B$SIMPSON, method = "spearman")
...
fam.ranked.sim_B <- data.frame(cbind(rank(data_family_16S_B$`ECe _values`, ties.method = "average"), rank(data_family_16S_B$SIMPSON, ties.method = "average")))
...
corr_fam_16S_shann_R <- cor.test(x=data_family_16S_R$`ECe _values`, y=data_family_16S_R$SHANNON, method = "spearman")
...
fam.ranked.shann_R <- data.frame(cbind(rank(data_family_16S_R$`ECe _values`, ties.method = "average"), rank(data_family_16S_R$SHANNON, ties.method = "average")))
...
corr_fam_16S_sim_R <- cor.test(x=data_family_16S_R$`ECe _values`, y=data_family_16S_R$SIMPSON, method = "spearman")
...
fam.ranked.sim_R <- data.frame(cbind(rank(data_family_16S_R$`ECe _values`, ties.method = "average"), rank(data_family_16S_R$SIMPSON, ties.method = "average")))
...
chao_gender_16S <- ddply(df_gender,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})

# ACE for Phylum of 16S
ACE_gender_16S <- ddply(df_gender,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
corr_gen_16S_shann_B <- cor.test(x=data_gender_16S_B$`ECe _values`, y=data_gender_16S_B$SHANNON, method = "spearman")
...
gen.ranked.shann_B <- data.frame(cbind(rank(data_gender_16S_B$`ECe _values`, ties.method = "average"), rank(data_gender_16S_B$SHANNON, ties.method = "average")))
...
corr_gen_16S_sim_B <- cor.test(x=data_gender_16S_B$`ECe _values`, y=data_gender_16S_B$SIMPSON, method = "spearman")
...
gen.ranked.sim_B <- data.frame(cbind(rank(data_gender_16S_B$`ECe _values`, ties.method = "average"), rank(data_gender_16S_B$SIMPSON, ties.method = "average")))
...
corr_gen_16S_shann_R <- cor.test(x=data_gender_16S_R$`ECe _values`, y=data_gender_16S_R$SHANNON, method = "spearman")
...
gen.ranked.shann_R <- data.frame(cbind(rank(data_gender_16S_R$`ECe _values`, ties.method = "average"), rank(data_gender_16S_R$SHANNON, ties.method = "average")))
...
corr_gen_16S_sim_R <- cor.test(x=data_gender_16S_R$`ECe _values`, y=data_gender_16S_R$SIMPSON, method = "spearman")
...
gen.ranked.sim_R <- data.frame(cbind(rank(data_gender_16S_R$`ECe _values`, ties.method = "average"), rank(data_gender_16S_R$SIMPSON, ties.method = "average")))
...
shannon_otu_16S <- ddply(t_otu,~Samples,function(x) {
  data.frame(SHANNON=diversity(x[-1], index = "shannon"))
})

# Simpson for OTU of 16S

simpson_otu_16S <- ddply(t_otu,~Samples,function(x) {
  data.frame(SIMPSON=diversity(x[-1], index = "simpson"))
})

# Chao1 for OTU of 16S

chao_otu_16S <- ddply(t_otu,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})

# ACE for OTU of 16S
ACE_otu_16S <- ddply(t_otu,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
