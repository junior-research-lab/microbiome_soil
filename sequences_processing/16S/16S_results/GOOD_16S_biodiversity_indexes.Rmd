...
View(chao_phylum_16S)
write.csv(chao_phylum_16S, file = "chao1_phylum_16S.csv", row.names = TRUE)
...
View(chao_order_16S)
write.csv(chao_order_16S, file = "chao1_order_16S.csv", row.names = TRUE)
...
View(chao_family_16S)
write.csv(chao_family_16S, file = "chao1_family_16S.csv", row.names = TRUE)
...
View(chao_gender_16S)
write.csv(chao_gender_16S, file = "chao1_gender_16S.csv", row.names = TRUE)
