...
shannon_phylum_ITS2 <- plyr::plyr::ddply(df_phylum,~Samples,function(x) {
  data.frame(SHANNON=diversity(x[-1], index = "shannon"))
})

# Simpson for Phylum of ITS2

simpson_phylum_ITS2 <- plyr::plyr::ddply(df_phylum,~Samples,function(x) {
...
chao_phylum_ITS2 <- plyr::plyr::ddply(df_phylum,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})


# ACE for Phylum of ITS2
ACE_phylum_ITS2 <- plyr::plyr::ddply(df_phylum,~Samples,function(x) {
...
shannon_order_ITS2 <- plyr::plyr::ddply(df_order,~Samples,function(x) {
  data.frame(SHANNON=diversity(x[-1], index = "shannon"))
})

# Simpson for Order of ITS2

simpson_order_ITS2 <- plyr::plyr::ddply(df_order,~Samples,function(x) {
  data.frame(SIMPSON=diversity(x[-1], index = "simpson"))
})

# Chao1 for Order of ITS2

chao_order_ITS2 <- plyr::plyr::ddply(df_order,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})


# ACE for Phylum of ITS2
ACE_order_ITS2 <- plyr::plyr::ddply(df_order,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
shannon_family_ITS2 <- plyr::plyr::ddply(df_family,~Samples,function(x) {
  data.frame(SHANNON=diversity(x[-1], index = "shannon"))
})
...
simpson_family_ITS2 <- plyr::plyr::ddply(df_family,~Samples,function(x) {
  data.frame(SIMPSON=diversity(x[-1], index = "simpson"))
})
...
chao_family_ITS2 <- plyr::plyr::ddply(df_family,~Samples,function(x) {
  data.frame(chao1 =chao1(x[-1], taxa.row = FALSE))
})

# ACE for Phylum of ITS2
ACE_family_ITS2 <- plyr::plyr::ddply(df_family,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
