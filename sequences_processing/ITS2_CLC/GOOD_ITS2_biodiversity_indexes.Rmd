...
ACE_phylum_ITS2 <- ddply(df_phylum,~Samples,function(x) {
...
# ACE for Phylum of ITS2
ACE_order_ITS2 <- ddply(df_order,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
# ACE for Phylum of ITS2
ACE_family_ITS2 <- ddply(df_family,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
...
# ACE for Phylum of ITS2
ACE_gender_ITS2 <- ddply(df_gender,~Samples,function(x) {
  data.frame(ACE = ACE(x[-1], taxa.row = FALSE))
})
