...
ggplot(data = ad0_w_unident, mapping = aes(x = Samples, y = Phylum_Frequency, fill=reorder(Phylum, -Phylum_Frequency))) + theme_bw() +
  ...
  ggtitle("Frequency of phylum reads per sample for ITS2 sequences") +
